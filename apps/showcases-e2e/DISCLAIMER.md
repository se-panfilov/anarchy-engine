...
Where Sergei Aleksandrovich Panfilov distributes **commercial binaries** of showcases-e2e, security support is handled as described in `SECURITY` (see **Security Support Period**).
