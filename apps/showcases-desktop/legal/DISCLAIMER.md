...
Where Sergei Aleksandrovich Panfilov distributes **commercial binaries** of the Software, security support is handled as described in `SECURITY` (see **Security Support Period**). Conformity and manufacturer obligations (where applicable) are addressed in the accompanying documentation (e.g., **EU Declaration of Conformity**, **Instructions**).
