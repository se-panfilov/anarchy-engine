import type { TKilometers, TKilometersPerHour, TMeters, TMetersPerSecond, TMilliseconds, TRadians, TRadiansPerSecond } from '@/Math/Types';
import { HOUR, SECOND } from '@/Measurements';
