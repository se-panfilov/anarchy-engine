# End User License Terms — showcases-shared
...
2. **Not a Market Placement by Maintainers.** This repository is **not** a product “placed on the market.” If **you** incorporate it into a **commercial product**, **you** are responsible for compliance with product-safety, cybersecurity (incl. EU CRA), privacy/data-protection, consumer, and export/sanctions laws.
...
For full OSS terms, see `LICENSE`.
