# Disclaimer of Warranty and Liability — showcases-shared
...
Where distributes **commercial binaries** of showcases-shared, security support is handled as described in `SECURITY.md` (see **Security Support Period**).
