...
3. **No Support Obligation.** The maintainers provide the project **without support commitments or SLAs**. See `SECURITY.md` for reporting.
4. **Third-Party Components (OSS Precedence).** Dependencies retain their own licenses and notices. **If this text ever conflicts with an OSS license for a specific component, the OSS license governs for that component.** See `NOTICE.md` / `THIRD_PARTY_LICENSES.md`.
