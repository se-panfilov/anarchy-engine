...
This policy applies to commercial builds of **{{PRODUCT_DISPLAY_NAME}}{{TRADEMARK_SYMBOL}}** (the “{{PRODUCT_TERM}}”). It explains how to report
...
- **Security support period:** **{{SECURITY_SUPPORT_PERIOD}}** (counted from the initial commercial release of the relevant major version), unless a
...
- **In scope:** issues that materially impact the confidentiality, integrity, or availability of the shipped {{PRODUCT_TERM}} or its **update
  mechanism**.
- **Out of scope:** social engineering, physical attacks, denial-of-service on third-party platforms, vulnerabilities in third-party stores or OS
  kernels not packaged with the {{PRODUCT_TERM}}, issues in unofficial forks or repackaged distributions.
...
{{PRODUCT_TERM}}. This policy does not authorize any activity that violates applicable law or third-party terms, and it does not protect actions that
