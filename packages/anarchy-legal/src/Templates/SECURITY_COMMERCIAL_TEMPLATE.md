...
This policy applies to commercial builds of **{{PACKAGE_NAME}}** distributed via **{{DISTRIBUTION_PLATFORMS}}**. It explains how to report potential security issues and how we handle them. **It does not create SLAs, warranties, or contractual obligations.**
...
**Governing Law:** subject to mandatory law, handled under **{{GOVERNING_LAW_COUNTRY}}/{{GOVERNING_VENUE}}**.
