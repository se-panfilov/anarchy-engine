# Privacy Notice — showcases-menu

**Effective date:** TBD until market release
**Controller:** Sergei Aleksandrovich Panfilov — Contact: TBD until market release

**Scope / Identification.** This notice applies to the **open-source repository** for **showcases-menu** (hosted on or mirrored to **public code hosting platform(s)**). We do **not** operate a consumer service through this repository.
