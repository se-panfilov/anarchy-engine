...
Where Sergei Aleksandrovich Panfilov distributes **commercial binaries** of showcases-menu, security support is handled as described in `SECURITY.md` (see **Security Support Period**).
