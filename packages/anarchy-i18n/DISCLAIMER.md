...
Where Sergei Aleksandrovich Panfilov distributes **commercial binaries** of anarchy-i18n, security support is handled as described in `SECURITY.md` (see **Security Support Period**).
