# Privacy Notice — @hellpig/anarchy-i18n

**Effective date:** 11 January 2026

**Controller:** Sergei Panfilov — Contact: pnf036+anarchy@gmail.com

**Scope / Identification.** This notice applies to the **open-source project** **@hellpig/anarchy-i18n** (hosted on or mirrored to **public code hosting platform(s)**). We do **not** operate a consumer service through this repository.
