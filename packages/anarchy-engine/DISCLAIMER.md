# Disclaimer of Warranty and Liability — anarchy-engine
...
Where distributes **commercial binaries** of anarchy-engine, security support is handled as described in `SECURITY.md` (see **Security Support Period**).
