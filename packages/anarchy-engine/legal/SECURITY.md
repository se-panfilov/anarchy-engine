...
This policy applies to the open-source project **@hellpig/anarchy-engine** (the “Project”). It is provided for community coordination only and **does not create service levels (SLAs), warranties, or contractual obligations**.
...
**Technical identifiers (optional):** `@hellpig/anarchy-engine`.
