# Security Policy — showcases-i18n
...
This policy applies to the open-source project **showcases-i18n** (the “Project”). It is provided for community coordination only and **does not create service levels (SLAs), warranties, or contractual obligations**.
...
**Technical identifiers (optional):** `showcases-i18n`.
