# Privacy Notice — anarchy-monorepo

**Effective date:** TBD until market release

**Controller:** Sergei Panfilov — Contact: pnf036+anarchy@gmail.com

**Scope / Identification.** This notice applies to the **open-source project** **anarchy-monorepo** (hosted on or mirrored to **public code hosting platform(s)**). We do **not** operate a consumer service through this repository.
