...
import type { TAbstractAudioWrapper, TAnyAudio, TAudioParams } from '@/Engine/Audio/Models';
...
export function AbstractAudioWrapper<T extends TAnyAudio>(params: TAudioParams, createFn: (audio: AudioBuffer, params: TAudioParams) => T): TAbstractAudioWrapper<T> {
