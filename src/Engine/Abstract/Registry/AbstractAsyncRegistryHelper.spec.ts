...
describe('AbstractAsyncRegistryHelper', () => {
  ...
  describe('getValueAsync', () => {
    it('should return the only entity that was added in the past', async () => {
      ...
      const filterFn = (entity: IRegistrable): boolean => entity.id === mockEntity1.id;
    ...
    it('should return the only entity that will be added later', async () => {
      const registry: IAbstractAsyncRegistry<IRegistrable> = AbstractAsyncRegistry<IRegistrable>('mockEntity' as RegistryType);
      const filterFn = (entity: IRegistrable): boolean => entity.id === mockEntity1.id;
    ...
    it('should return the only entity that will be added async later', async () => {
      const registry: IAbstractAsyncRegistry<IRegistrable> = AbstractAsyncRegistry<IRegistrable>('mockEntity' as RegistryType);
      const filterFn = (entity: IRegistrable): boolean => entity.id === mockEntity1.id;
    ...
    it('should return an entity that will be added among others later', async () => {
      const registry: IAbstractAsyncRegistry<IRegistrable> = AbstractAsyncRegistry<IRegistrable>('mockEntity' as RegistryType);
      const filterFn = (entity: IRegistrable): boolean => entity.id === mockEntity2.id;
      const promise: Promise<IRegistrable | undefined> = getValueAsync(registry, filterFn, undefined, waitingTime);
      registry.add(mockEntity1);
    ...
    it('should return an entity that will be added later, among the mixed added entities', async () => {
      const registry: IAbstractAsyncRegistry<IRegistrable> = AbstractAsyncRegistry<IRegistrable>('mockEntity' as RegistryType);
      registry.add(mockEntity1);
      registry.add(mockEntity2);
    ...
    it('should return an entity that will be added later, among the mixed async added entities', async () => {
      const registry: IAbstractAsyncRegistry<IRegistrable> = AbstractAsyncRegistry<IRegistrable>('mockEntity' as RegistryType);
      registry.add(mockEntity1);
