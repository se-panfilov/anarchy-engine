...
import type { TAbstractLoadedResourcePack, TAbstractLoader, TAbstractOnLoadFunction, TAbstractResourceAsyncRegistry, TAbstractResourceConfig } from '@/Engine/Abstract/Models';
import type { TDestroyable } from '@/Engine/Mixins';
import { destroyableMixin } from '@/Engine/Mixins';
import type { TWriteable } from '@/Engine/Utils';
import { isDefined } from '@/Engine/Utils';

export function AbstractLoader<L extends Loader<any>, R extends TAbstractResourceAsyncRegistry<T>, T, C extends TAbstractResourceConfig>(
  loader: L,
  registry: R,
  type: LoaderType
): TAbstractLoader<T, C> {
