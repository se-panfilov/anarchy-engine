...
const screenSizeWatcher: IScreenSizeWatcher = screenSizeWatcherFactory.create({ container, tags: [WatcherTags.Initial, WatcherTags.Global] }).start();
...
const mouseClickWatcher: IMouseClickWatcher = mouseClickWatcherFactory.create({ container, tags: [WatcherTags.Initial, WatcherTags.Global] }).start();
...
const mousePositionWatcher: IMousePositionWatcher = mousePositionWatcherFactory.create({ container, tags: [WatcherTags.Initial, WatcherTags.Global] }).start();
