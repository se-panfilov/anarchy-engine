...
export function textLoopEffect(
  ...
  return loop.tick$
    ...
    .subscribe(([, activeCameraW, text2dRenderer, text3dRenderer]: [TMilliseconds, TCameraWrapper | undefined, TText2dRenderer | undefined, TText3dRenderer | undefined]): void | never => {
