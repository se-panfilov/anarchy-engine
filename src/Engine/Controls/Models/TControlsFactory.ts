...
export type IControlsParamsFromConfig = Omit<TParamsFromConfig<TControlsConfig, TControlsParams>, 'configToParams'> &
  Readonly<{
    configToParams: (config: TControlsConfig, dependencies: TAdditionalControlsConfigParams) => TControlsParams;
  }>;

export type TControlsFactory = TReactiveFactory<TControlsWrapper, TControlsParams> & IControlsParamsFromConfig & TDestroyable;
