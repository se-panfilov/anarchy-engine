...
export const getParams: IGetParamsFn<IControlsParams, IControlsConfig> = (config: IControlsConfig, { cameraRegistry, canvas }: AdditionalControlsConfigParams): IControlsParams => {
