...
export type IControlsFactory = IFactory<IControlsWrapper, IControlsParams> & IReactiveFactory<IControlsWrapper> & IParamsFromConfig<IControlsConfig, IControlsParams> & IDestroyable;
