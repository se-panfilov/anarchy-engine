...
import type { IThreeJsRendererPropsAccessors } from '@/Engine/Domains/Renderer/Models';

export function withThreeJsRendererPropsAccessors(entity: WebGLRenderer): IThreeJsRendererPropsAccessors {
