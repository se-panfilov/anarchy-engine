...
function textBuilder(params: ITextParams): ITextWrapper | never {
...
const factory: IReactiveFactory<ITextWrapper, ITextParams> = { ...ReactiveFactory(FactoryType.Text, textBuilder) };
