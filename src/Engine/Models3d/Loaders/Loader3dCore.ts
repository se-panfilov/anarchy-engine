...
export function Loader3dCore<T, C extends TAbstractResourceConfig>(registry: TProtectedRegistry<TAbstractResourceAsyncRegistry<T>>, type: LoaderType): TAbstractLoader<T, C> {
