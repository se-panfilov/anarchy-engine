...
import type { TModel3dEntities, TModel3dFacade, TModel3dPack, TModel3dPrimitivePack, TModels3dFacadeParams } from '@/Engine/Models3d/Models';
...
export function Model3dFacade(params: TModels3dFacadeParams | TModel3dPrimitivePack, animationsService: TAnimationsService): TModel3dFacade {
  ...
  const getPack = (): TModel3dPack | TModel3dPrimitivePack => omitInObjectWithoutMutation({ ...entities, clonedFrom: facade.id }, ['actions', 'mixer']);

  // Be aware that this clone method doesn't save the facade to the registry, use clone() method of the service instead
  function _clone(overrides: TOptional<TModel3dPack | TModel3dPrimitivePack> = {}): TModel3dFacade {
