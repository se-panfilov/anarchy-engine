...
import type { TModel3dFacade, TModel3dFacadeParams } from '@/Engine/Models3d/Models';
...
// TODO 9.0.0. RESOURCES: remove Model3dPrimitiveFacade?
export function Model3dPrimitiveFacade(params: TModel3dFacadeParams): TModel3dFacade {
