...
import type { TModel3dFacade, TModel3dToModel3dFacadeConnectionRegistry, TModel3dToModel3dFacadeConnectionRegistryExtension } from '@/Engine/Models3d/Models';
...
registry.addModel3d = (model3d: Group | Mesh | Object3D, model3dFacade: TModel3dFacade): void => registry.add(model3d.uuid, model3dFacade.id);
// eslint-disable-next-line functional/immutable-data
registry.findByModel3d = (model3d: Group | Mesh | Object3D): string | undefined => registry.findByKey(model3d.uuid);
// eslint-disable-next-line functional/immutable-data
registry.setByModel3d = (model3d: Group | Mesh | Object3D, model3dFacade: TModel3dFacade): void => registry.add(model3d.uuid, model3dFacade.id);
// eslint-disable-next-line functional/immutable-data
