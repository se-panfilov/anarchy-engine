...
const factory: TReactiveFactoryWithDependencies<TModel3dFacade, TModel3dParams, Pick<TModels3dServiceDependencies, 'animationsService'>> = ReactiveFactoryWithDependencies(
