...
import type { TAbstractLightWrapper, TRectAreaLight, TRectAreaLightParams } from '@/Engine/Light/Models';

import { AbstractLightWrapper } from './AbstractLightWrapper';

export function RectAreaLightWrapper(params: TRectAreaLightParams): TAbstractLightWrapper<TRectAreaLight> {
