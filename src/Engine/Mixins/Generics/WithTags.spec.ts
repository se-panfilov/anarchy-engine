...
describe('withTags mixin', () => {
  ...
  describe('setTags', () => {
    it('should add new tags', (): void => {
      const instance: TWithTagsMixin = withTagsMixin([]);
    ...
    it('should replace old tags with new ones', (): void => {
      ...
      const instance: TWithTagsMixin = withTagsMixin([oldTag1, oldTag2]);
  ...
  describe('addTag', () => {
    it('should add new tag', () => {
      const instance: TWithTagsMixin = withTagsMixin([tag1, tag2]);
