import type { IRotatableZ, IWithRotationProperty } from '@/Engine/Mixins/GameObjects/Models';

import { withRotationMixin } from './WithRotationMixin';

export function withRotationByZMixin(entity: IWithRotationProperty): IRotatableZ {
