import type { IRotatableX, IWithRotationProperty } from '@/Engine/Mixins/GameObjects/Models';

import { withRotationMixin } from './WithRotationMixin';

export function withRotationByXMixin(entity: IWithRotationProperty): IRotatableX {
