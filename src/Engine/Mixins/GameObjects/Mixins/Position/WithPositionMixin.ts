import type { IWithPosition, IWithPositionProperty } from '@/Engine/Mixins/GameObjects/Models';
...
export function withPositionMixin(entity: IWithPositionProperty): IWithPosition | never {
