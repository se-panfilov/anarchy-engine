...
describe('withTags mixin', () => {
  ...
  describe('setTags', () => {
    it('should add new tags', (): void => {
      const instance: IWithTags<string> = withTags<string>([]);
    ...
    it('should replace old tags with new ones', (): void => {
      ...
      const instance: IWithTags<string> = withTags<string>([oldTag1, oldTag2]);
  ...
  describe('addTag', () => {
    it('should add new tag', () => {
      const instance: IWithTags<string> = withTags<string>([tag1, tag2]);
