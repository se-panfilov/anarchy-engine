...
describe('withTags mixin', () => {
  ...
  describe('setTags', () => {
    it('should add new tags', (): void => {
      const instance: IWithTags<string> = withTagsMixin<string>([]);
    ...
    it('should replace old tags with new ones', (): void => {
      ...
      const instance: IWithTags<string> = withTagsMixin<string>([oldTag1, oldTag2]);
  ...
  describe('addTag', () => {
    it('should add new tag', () => {
      const instance: IWithTags<string> = withTagsMixin<string>([tag1, tag2]);
