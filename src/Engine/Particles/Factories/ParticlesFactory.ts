...
const factory: TReactiveFactory<TParticlesWrapper, TParticlesParams> = {
  ...ReactiveFactory(FactoryType.Particles, ParticlesWrapper as TCreateEntityFactoryFn<TParticlesWrapper, TParticlesParams>)
};
