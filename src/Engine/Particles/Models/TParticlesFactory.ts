...
export type TParticlesFactory = TAsyncReactiveFactory<TParticlesWrapperAsync, TParticlesParams> &
  TParamsFromConfig<TParticlesConfig, TParticlesParams, TParticlesConfigToParamsDependencies> &
  TDestroyable;
