...
registry.addModel3dFacade = (model3d: TModel3dFacade, actor: TActor): void => registry.add(model3d.id, actor.id);
// eslint-disable-next-line functional/immutable-data
registry.findByModel3dFacade = (model3d: TModel3dFacade): string | undefined => registry.findByKey(model3d.id);
// eslint-disable-next-line functional/immutable-data
registry.setByModel3dFacade = (model3d: TModel3dFacade, actor: TActor): void => registry.add(model3d.id, actor.id);
// eslint-disable-next-line functional/immutable-data
