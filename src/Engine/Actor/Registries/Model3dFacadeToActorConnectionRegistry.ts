...
import type { TActor, TModel3dFacadeToActorConnectionRegistry, TModel3dFacadeToActorConnectionRegistryExtension } from '@/Engine/Actor/Models';
...
registry.addModel3dFacade = (model3d: TModel3d, actor: TActor): void => registry.add(model3d.id, actor.id);
// eslint-disable-next-line functional/immutable-data
registry.findByModel3dFacade = (model3d: TModel3d): string | undefined => registry.findByKey(model3d.id);
// eslint-disable-next-line functional/immutable-data
registry.setByModel3dFacade = (model3d: TModel3d, actor: TActor): void => registry.add(model3d.id, actor.id);
// eslint-disable-next-line functional/immutable-data
registry.removeByModel3dFacade = (model3d: TModel3d): void => registry.remove(model3d.id);
// eslint-disable-next-line functional/immutable-data
