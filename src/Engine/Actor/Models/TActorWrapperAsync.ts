...
import type { TWithPhysicsBodyFacade } from '@/Engine/Physics';
import type { TWithTextures } from '@/Engine/Texture';
import type { TMesh } from '@/Engine/ThreeLib';

export type TActorWrapperAsync = TWrapper<TMesh> & TMovable3dXYZ & TRotatable & TScalable & TWithObject3d & TWithMaterial & TWithTextures & TWithPhysicsBodyFacade & TWithTagsMixin;
