...
export type TBvhService = Readonly<{
  ...
  raycastWithBvh: (actorW: TActorWrapper, raycaster: Raycaster, intersects: Array<Intersection>) => void;
  createBvhForActor: (actorW: TActorWrapper, options?: TBvhOptions) => void;
  _debugVisualizeBvhForActor: (actorW: TActorWrapper, sceneW: TSceneWrapper, depth?: number) => void;
