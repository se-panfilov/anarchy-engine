...
import type { TInstantTransformDriver, TTransformDriverParams } from '@/Engine/TransformDrive/Models';
import type { TWithUndefined } from '@/Engine/Utils';
import { updateSubjOnChange } from '@/Engine/Utils';

export function InstantTransformDriver(params: TTransformDriverParams): TInstantTransformDriver {
