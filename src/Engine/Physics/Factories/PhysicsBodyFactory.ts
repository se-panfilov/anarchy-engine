...
const factory: TReactiveFactory<TPhysicsBodyFacade, TPhysicsBodyParams> = {
  ...ReactiveFactory(FactoryType.PhysicsBody, PhysicsBodyFacade as TCreateEntityFactoryFn<TPhysicsBodyFacade, TPhysicsBodyParams>)
};
