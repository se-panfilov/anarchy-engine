...
export type TPhysicsBodyFactory = TReactiveFactory<TPhysicsBodyFacade, TPhysicsBodyParams> & TParamsFromConfig<TPhysicsBodyConfig, TPhysicsBodyParams> & TDestroyable;
