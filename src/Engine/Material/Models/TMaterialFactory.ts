...
export type TMaterialFactory = TReactiveFactory<TMaterialWrapper, TMaterialParams> &
  TParamsFromConfigWithDependencies<TMaterialConfig, TMaterialParams, TMaterialConfigToParamsDependencies> &
  TDestroyable;
