...
export type TMaterialPackParams<T extends TMaterialTexturePack> = Readonly<{ type: MaterialType; params?: TMaterialProps; textures?: T }> & TWithNameRequired & TWithReadonlyTags;
