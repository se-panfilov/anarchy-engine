...
export function showcaseLevel(canvas: IAppCanvas): IShowcase {
  ...
  function start(): void {
    ...
    const redText: IText2dWrapper | undefined = textRegistry.getUniqByTag('red');
    const blueText: IText2dWrapper | undefined = textRegistry.getUniqByTag('blue');
    const greenText: IText2dWrapper | undefined = textRegistry.getUniqByTag('green');
